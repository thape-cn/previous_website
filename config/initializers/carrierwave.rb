CarrierWave.configure do |config|
  ...
  config.aliyun_access_id  = Rails.application.credentials.dig(:aliyun, :access_key_id)
  config.aliyun_access_key = Rails.application.credentials.dig(:aliyun, :secret_access_key)
